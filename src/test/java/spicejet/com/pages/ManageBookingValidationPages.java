...
public class ManageBookingValidationPages extends BaseTestSJ {
	
	@FindBy(xpath="//div[text()='manage booking']")
	WebElement manageBooking;
	
	public void clickOnManageBooking() {
		waitForElement(manageBooking);
		clickAction(manageBooking);
		
		//System.out.println("Manage booking validation successful");
	}
